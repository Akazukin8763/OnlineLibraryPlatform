...
<html lang="en">
    <head>
        ...
        <title>Online Library Platform｜Notification</title>
        ...
        <script type="module">
            import { viewNotification } from "./SearchViewModule/View/view.js";
            ...
            window.addEventListener("load", viewNotification, false);
        </script>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <br>
                <h3 class="text-center"><span class="glyphicon glyphicon-bell" style="color: #FFA042;"></span> 通知</h3>
                ...
                <div class="col-sm-8">
                    <table class="table table-bordered" style="table-layout: fixed;">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col" style="width: 25%;">Notify Date</th>
