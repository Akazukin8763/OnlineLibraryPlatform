...
<html lang="en">
    <head>
        ...
        <title>Online Library Platform｜History</title>
        ...
        <script type="module">
            import { viewHistory } from "./SearchViewModule/View/view.js";
            ...
            window.addEventListener("load", showHistory, false);
        </script>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <br>
                <h3 class="text-center"><span class="glyphicon glyphicon-time" style="color: #FFA042;"></span> 歷史紀錄</h3>
